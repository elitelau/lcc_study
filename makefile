# $Id: unix.m4,v 1.4 1997/07/03 16:16:52 drh Exp $
TEMPDIR=/tmp
A=.a
O=.o
E=
...
# $Id: makefile.m4,v 1.12 1998/09/08 23:47:23 drh Exp $
...
$Bexpr$O:	src/expr.c src/print_dag.h;	$(CC) $(CFLAGS) -c -Isrc -o $@ src/expr.c
...
$Bmain$O:	src/main.c src/print_dag.h;	$(CC) $(CFLAGS) -c -Isrc -o $@ src/main.c
...
$Bprint_dag$O:	src/print_dag.c src/print_dag.h src/sglib.h;	$(CC) $(CFLAGS) -c -Isrc -o $@ src/print_dag.c
